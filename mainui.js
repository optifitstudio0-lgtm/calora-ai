...
function ReportsStackNavigator({ theme, t }) { 
  return ( 
...
const styles = { 
    ...
    sectionTitle: (theme) => ({ fontSize: 22, fontWeight: 'bold', color: theme.textPrimary, textAlign: 'auto', marginBottom: 0, flexShrink: 1 }), 
    sectionDescription: (theme) => ({ fontSize: 14, color: theme.textSecondary, textAlign: 'auto' }), 
    ...
    readOnlyBannerText: (theme) => ({ color: theme.white, fontSize: 14, fontWeight: 'bold', flex: 1, textAlign: 'auto' }), 
    ...
    searchInput: (theme) => ({ flex: 1, height: 50, backgroundColor: theme.background, borderRadius: 10, paddingHorizontal: 15, fontSize: 16, textAlign: 'auto', color: theme.textPrimary }), 
    ...
    smallCardTitle: (theme) => ({ fontSize: 16, fontWeight: '600', color: theme.textPrimary, marginHorizontal: 8 }), 
    smallCardValue: (theme) => ({ fontSize: 28, fontWeight: 'bold', color: theme.textPrimary, textAlign: 'auto', }), 
    smallCardSubValue: (theme) => ({ fontSize: 14, color: theme.textSecondary, textAlign: 'auto', marginTop: -5, }), 
    ...
    foodLogItemName: (theme) => ({ fontSize: 16, fontWeight : '600', color: theme.textPrimary, flex: 1, textAlign: 'auto', }), 
